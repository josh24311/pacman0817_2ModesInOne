...
public final class Game {
    ...
    public Boolean isPillStillAvailable(int pillIndex) {
        if (po) {
            ...
            //System.out.print("pl:");
            //System.out.println(pillLocation);
    ...
    /**
     * new function to get pill without PO check
     * @revise time 2017/7/15
     * @param PillIndex The   pill index
     * @return true, if is   pill still available
     */
public Boolean isPillStillAvailable_new(int pillIndex) {
    ...
    /**
     * new function to get powerpill without PO check
     * @revise time 2017/7/14
     * @param powerPillIndex The power pill index
     * @return true, if is power pill still available
     */
public Boolean isPowerPillStillAvailable_new(int powerPillIndex) {
    ...
    /**
     * Current node at which the specified ghost resides.
     * @revise 2017/7/16 ,take off PO check,return index
     * @param ghostType the ghost type
     * @return the ghost current node index
     */
    public int getGhostCurrentNodeIndex_new(GHOST ghostType) {
    ...
    /**
     * Returns the edible time for the specified ghost.
     * @revise 2017/7/16 ,take off the po check,return edibleTime directly
     * @param ghostType the ghost type
     * @return the ghost edible time
     */
    public int getGhostEdibleTime_new(GHOST ghostType) {
    ...
    /**
     * Time left that the specified ghost will spend in the lair.
     * @revise 7/19 take off po
     * @param ghostType the ghost type
     * @return the ghost lair time
     */
    public int getGhostLairTime_new(GHOST ghostType) {
    ...
    public int getShortestPathDistance(int fromNodeIndex, int toNodeIndex) {
        if (fromNodeIndex == toNodeIndex) {
        	...
        	//System.out.println("F: "+fromNodeIndex+" T: "+toNodeIndex);
            return currentMaze.shortestPathDistances[((toNodeIndex * (toNodeIndex + 1)) / 2) + fromNodeIndex];
        } else {
        	//System.out.println("F: "+fromNodeIndex+" T: "+toNodeIndex);
        	/*
        	 * 20170804
        	 * fix problem: fromNodeIndex = 0,toNodeIndex = -1
        	 * return 0 directly*/
        	if(fromNodeIndex==0)
        	{
        		return 0;
    ...
    /**
     * new function to show neighborhood of certain node
     * @date 20170727
     * @param index of target node
     * @return Neighborhoods of this node
     */
    public void showNeighbour(int targetNode){
    	System.out.println(currentMaze.graph[targetNode].allNeighbourhoods.entrySet());
